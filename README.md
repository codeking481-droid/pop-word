...
The editor displays the live plan as approximately `$5/month` beside Upgrade.
Paystack charges the configured plan currency and amount (currently NGN 7,500,
the configured local-currency equivalent);
